...
#    os.system("python " + script_path + "hpc_echo_sysargv.py " + env_path + " " + sys.argv[1] + " " + working_dir + " " + job_id + " " + user_email)
    ...
    if sys.argv[4] == "True":
        ...
        os.system("python " + script_path + "hpc_echo_sysargv.py " + env_path + " " + regex + " " +  sys.argv[5] + " " + sys.argv[5] + " " + working_dir + " " + job_id + " " + user_email) 
        if includes_params_file:
            os.system("python " + script_path + "hpc_generate_sas.py " + env_path + " " + regex + " " +  sys.argv[5] + " " + sys.argv[5] + " " + working_dir + " " + job_id + " " + user_email + " " + parameters)
        else:
            os.system("python " + script_path + "hpc_generate_sas.py " + env_path + " " + regex + " " +  sys.argv[5] + " " + sys.argv[5] + " " + working_dir + " " + job_id + " " + user_email)
